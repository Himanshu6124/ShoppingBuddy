...
import com.himanshu.shoppingbuddy.databinding.ActivityDashboardBinding
...
class DashboardActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.setBackgroundDrawable(resources.getDrawable(R.drawable.app_gradient_color_background))
