package com.himanshu.shoppingbuddy.Firestore
...
import com.himanshu.shoppingbuddy.ui.activities.AddressListActivity
...
import com.himanshu.shoppingbuddy.ui.activities.LoginActivity
import com.himanshu.shoppingbuddy.ui.activities.ProductDetailsActivity
import com.himanshu.shoppingbuddy.ui.activities.RegisterActivity
import com.himanshu.shoppingbuddy.ui.activities.SettingActivity
import com.himanshu.shoppingbuddy.ui.activities.UserProfileActivity
import com.himanshu.shoppingbuddy.ui.fragments.DashboardFragment
import com.himanshu.shoppingbuddy.ui.fragments.OrdersFragment
import com.himanshu.shoppingbuddy.ui.fragments.ProductsFragment
import com.himanshu.shoppingbuddy.ui.fragments.SoldProductsFragment
...
class FirestoreClass {
    ...
    fun uploadProductDetails(activity: AddProductActivity, productInfo: Product) {
        ...
        mFireStore.collection(Constants.PRODUCTS)
            .document() //not defined parameter inside document
    ...
    fun addCartItems(activity: ProductDetailsActivity, addToCart: CartItems) {
    ...
    fun getCartList(activity: Activity) {
        ...
        mFireStore.collection(Constants.CART_ITEMS)
            ...
            .addOnSuccessListener { document ->
                ...
                val list: ArrayList<CartItems> = ArrayList()

                // A for loop as per the list of documents to convert them into Cart Items ArrayList.
                for (i in document.documents) {

                    val cartItem = i.toObject(CartItems::class.java)!!
                    cartItem.id = i.id
    ...
    fun placeOrder(activity: CheckoutActivity, order: Order) {
        ...
        mFireStore.collection(Constants.ORDERS)
            .document()
            // Here the userInfo are Field and the SetOption   set to merge. It is for if we wants to merge
     ...
     */
    fun updateAllDetails(activity: CheckoutActivity, cartList: ArrayList<CartItems>, order: Order) {
        // END
